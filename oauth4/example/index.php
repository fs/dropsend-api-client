...
$req_req = oauthrequest_from_consumer_and_token($test_consumer, NULL, "GET", $base_url . "/request_token.php");
$req_req->sign_request($sig_method, $test_consumer, NULL);

$acc_req = oauthrequest_from_consumer_and_token($test_consumer, $req_token, "GET", $base_url . "/access_token.php");
$acc_req->sign_request($sig_method, $test_consumer, $req_token);

$echo_req = oauthrequest_from_consumer_and_token($test_consumer, $acc_token, "GET", $base_url . "/echo_api.php", array("method"=> "foo%20bar", "bar" => "baz"));
...
<h4>Example</h4>
<a href="<?php echo $req_req->__toString(); ?>"><?php echo $req_req->__toString(); ?></a>
...
<h4>Example</h4>
<a href="<?php echo $acc_req->__toString(); ?>"><?php echo $acc_req->__toString(); ?></a>
...
<h4>Example</h4>
<a href="<?php echo $echo_req->__toString(); ?>"><?php echo $echo_req->__toString(); ?></a>
