...
if ($action == "request_token") {
  ...
  $req_req = oauthrequest_from_consumer_and_token($test_consumer, NULL, "GET", $endpoint, $params);
  ...
  $acc_req = oauthrequest_from_consumer_and_token($test_consumer, $test_token, "GET", $endpoint, $params);
